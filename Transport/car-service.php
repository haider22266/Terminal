		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span6" style="margin:10px" >
					<div class="mainmenu">
						<ul>
							<li><a href="" style="color:Red ">Rent Car Station</a></li>
							<li><a href="http://localhost/Transport/rent-car.php?email='<?php echo $user['email']?>'">Rent Car</a></li>
			...
			<div class="row index_three_notice_hole">
				<div class="span4 index_three_notice">
					<center><h1><a href="">Travel Car</a></h1>
					<a href="tution.html"><img src="img/car1.jpg"/></a>
					</center>
				</div>
				<div class="span4 index_three_notice">
					<center><h1><a href="">Tourist Car</a></h1>
					<a href="admission.html"><img src="img/car2.jpg"/></a>
					</center>
				</div>
				<div class="span4 index_three_notice">
					<center>
					<h1><a href="">Regular Car</a></h1>
					<a href=""><img src="img/car3.jpg"/></a><br>
					</center>
				</div>
