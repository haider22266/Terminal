	...
	<body>
		...
		<div class="container">
			<div class="row logout">
					...
					<div class="span12" >
						<a href="#" style="font-family:'Abel' " ><b>LogOut</b></a>
					</div>
			...
			<div class="row">
				...
				<div class="span6" style="margin:10px" >
					<div class="mainmenu">
						<ul>
							<li><a href="" style="color:Red ">Bus Stand</a></li>
							<li><a href="http://localhost/Transport/busticket.php">Purchase-Ticket</a></li>
							<li><a href="http://localhost/Transport/change-password.php">Change-Password</a></li>
			...
			<div class="row index_three_notice_hole">
				<div class="span4 index_three_notice">
					<center><h1><a href="">Travel Bus</a></h1>
					<a href="tution.html"><img src="img/bus7.jpg"/></a>
					</center>
				</div>
				<div class="span4 index_three_notice">
					<center><h1><a href="">Tourist Bus</a></h1>
					<a href="admission.html"><img src="img/bus3.jpg"/></a>
					</center>
				</div>
				<div class="span4 index_three_notice">
					<center>
					<h1><a href="">Regular Bus</a></h1>
					<a href=""><img src="img/bus5.jpg"/></a><br>
					</center>
				</div>
			...
			<div class="row index_one_apply">
				<div class="span12">
					<center><h1><a href="#">Emergency Bus</a></h1></center>
				</div>
			</div>
			<div class="row footer" style="text-align:center;color:white;background-image: url(img/wallpaper-2562466.jpg);text-decoration:none">
				<div class="span4">
					<h3>Menu</h3>
					<p><a href="http://localhost/uniPro/LoginPageDIU/">Automation Login</a></p>
					<p><a href="">Academic calender</a></p>
					<p><a href="">Faculty Members</a></p>
