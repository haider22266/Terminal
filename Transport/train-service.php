		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span6" style="margin:10px" >
					<div class="mainmenu">
						<ul>
							<li><a href="" style="color:Red ">Train Station</a></li>
							<li><a href="http://localhost/Transport/trainticket.php?email='<?php echo $user['email']?>'">Purchase-Ticket</a></li>
			...
			<div class="row index_three_notice_hole">
				<div class="span4 index_three_notice">
					<center><h1><a href="">Travel Train</a></h1>
					<a href="tution.html"><img src="img/train1.jpg"/></a>
					</center>
				</div>
				<div class="span4 index_three_notice">
					<center><h1><a href="">Tourist Train</a></h1>
					<a href="admission.html"><img src="img/train2.jpg"/></a>
					</center>
				</div>
				<div class="span4 index_three_notice">
					<center>
					<h1><a href="">Regular Train</a></h1>
					<a href=""><img src="img/train3.jpg"/></a><br>
					</center>
				</div>
			...
			<div class="row index_one_apply">
				<div class="span12">
					<center><h1><a href="#">Emergency Train</a></h1></center>
				</div>
			</div>
