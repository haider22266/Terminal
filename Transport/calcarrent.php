...
<body>
	<div class="container" align="center">
        ...
        <form action="calcarrent.php" method="get" align="center">
		...
		<?php
				if(isset( $_GET["choice"] ))
				{
					...
					$query="select*from calcarrent where A1='$food[0]'";
                    $query_check=mysqli_query($con,$query);
                    if($query_check)
                    {
                        if(mysqli_num_rows($query_check)>0)
                        {
                            ...
                            <script>
                                ...
                                window.location.href='calcarrent.php';
                            </script>
                            ";
					...
					echo"
                            <script>
                                ...
                                window.location.href='carrentverify.php';
                            </script>
                            ";
					$insertion =" insert into calcarrent  values('$food[0]','$food[1]','$food[2]','$food[3]')";
