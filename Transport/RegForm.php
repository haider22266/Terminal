...
<body>
	<div class="container">
        ...
        <form action="RegForm.php" method="POST" align="center">
           ...
           if(isset($_POST['reg']))
            {
                ...
                if($password==$cpassword)
                {
                    ...
                    if($query_check)
                    {
                        ...
                        {
                          $insertion =" insert into users (name,address,number,email,password) values('$name','$address','$number','$email','$password')";
