...
<body>
	<div class="container" align="center">
        ...
        <form action="callaunchticket1.php" method="get" align="center">
		...
		<?php
				if(isset( $_GET["choice"] ))
				{
					...
					$query="select*from callaunchticket1 where A1='$food[0]'";
                    $query_check=mysqli_query($con,$query);
                    if($query_check)
                    {
					...
					echo"
                            ...
                            ";
					$insertion =" insert into callaunchticket1  values('$food[0]','$food[1]','$food[2]','$food[3]')";
