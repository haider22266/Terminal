        ...
        <img src="images/avatar.png"  width="100" height="100">
            <table align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input name="password" type="text" id="form" placeholder="Enter Your Password" required></input>
                ...
                <tr>
                    <td>
                       <a href="admin-regform.php"> <button name="reg" type="button" class="btn">Registration</button></a>
                    </td>
                    <td>
		...
		<?php
			if(isset($_POST['login']))
			{
				...
				if($query_run)
				{
					...
					header( "Location: busticketview.php?email='$email'");
					}
					else
					{
