  ...
  <div id="wrapper">
      ...
      <div class="container " >
        ...
        <div class="row nomargin">
          <div class="span12">
            <div class="headnav">
              <ul>
                <li><a href="index.html" data-toggle=""><i class="icon-user"></i> LogOut</a></li>
        ...
        <div class="row">
          <div class="span4">
            <div class="logo">
              ...
              <h1>Transportation Services Provider</h1>
            </div>
          </div>
          <div class="span8">
                  ...
                  <ul class="nav topnav">
					...
					<li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="bus-service.php?email='<?php echo $user['email']?>'">Bus Service</li>
                        <li><a href="train-service.php?email='<?php echo $user['email']?>'">Train Service</li>
                        <li><a href="launch-service.php?email='<?php echo $user['email']?>'">launch-service</li>
                        <li><a href="car-service.php?email='<?php echo $user['email']?>'">Car Services</li>
                        
                
                        <li><a href="">High Way Bus Services</a></li>
    ...
    <section id="featured">
      ...
      <div id="nivo-slider">
        <div class="nivo-slider" >
          ...
          <!-- Slide #2 image -->
          <img src="img/slides/nivo/bg-1.jpg" alt="" title="#caption-2" />
          <!-- Slide #3 image -->
          ...
          <div class="row">
            <div class="span12">
              ...
              <div class="nivo-caption" id="caption-1">
                <div>
                  <h2>Awesome <strong>Services</strong></h2>
                  <p>
              ...
              <div class="nivo-caption" id="caption-2">
                <div>
                  <h2>Fully <strong>Free Services</strong></h2>
                  <p>
                    Lorem ipsum dolor sit amet nsectetuer nec Vivamus. Curabitu laoreet amet eget. Viurab oremd ellentesque ameteget. Lorem ipsum dolor sit amet nsectetuer nec vivamus.
                  </p>
                  <a href="#" class="btn btn-theme">Read More</a>
      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            <div class="big-cta">
              <div class="cta-text">
                <h3>We Have Multiple <span class="highlight"><strong>Services</strong></span> this year!</h3>
              </div>
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="row">
          <div class="span12">
            <h4 class="heading">Some of recent <strong>Car</strong></h4>
            <div class="row">
              <section id="projects">
        ...
        <!-- end divider -->
        <div class="row" background-color="#ADD8E6">
          <div class="span12">
