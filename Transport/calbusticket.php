...
<body>
	<div class="container" align="center">
        ...
        <form action="calbusticket.php" method="get" align="center">
		...
		<?php
				if(isset( $_GET["choice"] ))
				{
					...
					$query="select*from calbusticket where A1='$food[0]'";
                    $query_check=mysqli_query($con,$query);
                    if($query_check)
                    {
					...
					echo"
                            <script>
                                ...
                                window.location.href='busticketverify.php';
                            </script>
                            ";
					$insertion =" insert into calbusticket  values('$food[0]','$food[1]','$food[2]','$food[3]')";
