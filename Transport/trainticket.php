...
<body>
	<div class="container">
        <br>
        <h1 align="center" >Purchasing Train Ticket Now</h1>
		 <?php
          

        ?>
        <form action="trainticket.php" method="POST" align="center">
             ...
             <table align="center" >
                ...
                <tr>
				 ...
				 <tr>
                    <td><label>Train License<label>   </td>
           ...
           if(isset($_POST['confirm']))
            {
               ...
               $email=$_POST['email'];
                ...
                $license=$_POST['license'];
					...
					$insertion =" insert into trainticketinfo  values('$from','$to','$email','$number','$license')";
                          $run=mysqli_query($con,$insertion);
                          if($run)
                          {
							// header( "Location: caltrainticket.php");
                            echo"
                            <script>
