...
<body>
	<div class="container">
        <br>
        <h1 align="center" >Rent A Car Now</h1>
		 <?php
          

        ?>
        <form action="rent-car.php" method="POST" align="center">
           ...
           if(isset($_POST['confirm']))
            {
               ...
               $email=$_POST['email'];
                ...
                $license=$_POST['license'];
					...
					$insertion =" insert into rentcarinfo  values('$from','$to','$email','$number','$license')";
                          $run=mysqli_query($con,$insertion);
                          if($run)
                          {
